...
!function (e) {
    ...
    e.fn.poptrox = function (o) {
        ...
        var v = x.find(".pic"),
            ...
            P = y.add(S);
        if (r.usePopupDefaultStyling && (
            x.css("background", r.popupBackgroundColor).css("color", r.popupTextColor).css("padding", r.popupPadding + "px"),
            m.length > 0 && (
            ...
            b.length > 0 && b.html("").css("position", "relative").css("font-size", r.popupLoaderTextSize).on("startSpinning", function (o) {
                ...
                t
                    ...
                    .css("margin-top", Math.floor((x.height() - t.height() + (
                        m.length > 0
                            ? m.height()
                            : 0
                    )) / 2))
            ...
            y
                ...
                .css("width", k)
                .html(
                    '<div style="position: absolute; height: 100px; width: 125px; top: 50%; right: ' +
                    '0; margin-top: -50px;">&gt;</div>'
                ),
            S
                .css("left", "0")
                .css("width", T)
                .html(
                    '<div style="position: absolute; height: 100px; width: 125px; top: 50%; left: 0' +
                    '; margin-top: -50px;">&lt;</div>'
                )
        }
        ...
        l
            ...
            .append(
                ...
                r.overlayColor + ";opacity:" + r.overlayOpacity + ";filter:alpha(opacity=" +
                100 * r.overlayOpacity + ');"></div>'
            )
            .hide()
        ...
        x
            ...
            .on("poptrox_switch", function (o, p, i) {
                ...
                if (
                    ...
                    a = s.height,
                    "%" == n.slice(-1) && (
                        n = parseInt(n.substring(0, n.length - 1)) / 100 * u.width()
                    ),
                    "%" == a.slice(-1) && (
                        a = parseInt(a.substring(0, a.length - 1)) / 100 * u.height()
                    ),
                    w
                        .css("position", "relative")
                        .css("outline", "0")
            ...
            .each(function (o) {
                ...
                if ("ignore" != n && i.attr("href")) {
                    ...
                    switch (p = t.src.match(/\/\/[a-z0-9\.]+\/(.*)/), t.type) {
                        ...
                        default:
                            if (
                                t.object = e('<img src="" alt="" style="vertical-align:bottom" />'),
                                r.preload
                            ) {
                    ...
                    "file:" == window.location.protocol && t
                        .src
                        .match(/^\/\//) && (t.src = "http:" + t.src),
                    d.push(t),
                    s.removeAttr("title"),
                    i
                        .removeAttr("href")
