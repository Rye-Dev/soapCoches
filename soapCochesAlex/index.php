<!DOCTYPE HTML>
<!-- Full Motion by TEMPLATED templated.co @templatedco Released for free under
the Creative Commons Attribution 3.0 license (templated.co/license) -->
<html>
    <head>
    ...
    <body id="top">
        ...
        <!-- Banner -->
        <!-- To use a video as your background, set data-video to the name of your video
        without its extension (eg. images/banner). Your video must be available in both
        .mp4 and .webm formats to work correctly. -->
            ...
            <div class="inner">
                ...
                <div class="thumbnails">
                    ...
                    <div class="box">
                        ...
                        <div class="inner">
                            <h3>
                                <a href="modelos.php?marca=<?= $marca ?>" data-poptrox="ajax,600x400">Modelos
                                    <?= $marca ?></a>
                            </h3>
        ...
        <footer id="footer">
            <div class="inner">
                ...
                <p>A responsive video gallery template with a functional lightbox<br/>
                    ...
                    and released under the Creative Commons License.</p>
